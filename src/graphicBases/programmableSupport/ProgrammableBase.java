...
public abstract class ProgrammableBase {
    ...
    private int shaderProgram; // 着色器程序的句柄
    private final int vbo; // 顶点缓冲对象的句柄
    ...
    public void allReadyDraw(GL4 gl4){
        materialDraw(gl4);
